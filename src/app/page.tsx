      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-10 leading-relaxed">
            Connect your Salesforce org and get {TOTAL_CHECKS} deterministic CPQ + Billing + ARM health checks in 3 seconds.
            The 4-week audit, automated &mdash; same expert-coded checks every time, with AI explaining
            each finding when you want a deeper read.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              OrgPrism finds what&rsquo;s already broken in your org &mdash; not what might break next.
              {TOTAL_CHECKS} deterministic checks, white-label reports, and AI on tap when you want it.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                icon: Zap,
                title: `${TOTAL_CHECKS} Deterministic Health Checks`,
                desc: `Same data, same findings — every time. Expert-coded SOQL checks across price rules, products, approval rules, billing, ARM selling models, bundles, rate cards, contracts — ${TOTAL_CATEGORIES} categories. No vibes, no hallucinations.`,
                color: 'amber',
              },
              {
                icon: Sparkles,
                title: 'Optional AI Explanations',
                desc: 'Once a finding is detected, click to get a plain-English explanation and a step-by-step fix plan generated by Gemini. The findings come first; AI is the colour commentary.',
                color: 'purple',
              },
              {
                icon: FileText,
